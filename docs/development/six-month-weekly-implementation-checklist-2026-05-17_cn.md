...
| 第 4 周 | 2026-06-07 至 2026-06-16 | 第 1 月 release gate | Core trust checkpoint 和可复现实验证据 | 已启动；已添加 offline release preflight command，用于 docs-localization 与 capability-matrix validation；详见 [第 1 月 release gate 预检](month1-release-gate-preflight-2026-05-18_cn.md) |
