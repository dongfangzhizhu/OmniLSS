...
|---|---|---|---|---|
| 1 | 2026-05-17 to 2026-05-23 | D1/D2 trustworthy artifacts and parser safety | Schema v2 present, default training-data redaction, structured prediction errors, robust smooth/tensor argument parsing, artifact validator | In progress; core gates implemented and validator added |
| 2 | 2026-05-24 to 2026-05-30 | D1/D2 prediction hardening | Legacy prediction entry points audited; public artifact-schema examples added | Pending |
