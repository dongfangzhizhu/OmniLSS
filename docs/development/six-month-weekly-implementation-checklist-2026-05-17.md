...
| 3 | 2026-05-31 to 2026-06-06 | D3 capability gates | Runtime capability matrix fully aligned with docs and strict routing | Complete for current Month 1 scope; matrix artifact, HTTP/gRPC responses, `gamlss()` strict routing, service route-admission reports, importable helper APIs, schema version, and matrix validator are synchronized; validation expansion and async-job admission are deferred to later planned work |
| 4 | 2026-06-07 to 2026-06-16 | Month 1 release gate | Core trust checkpoint with reproducible test evidence | Complete for offline gate; docs-localization, capability-matrix validation, artifact validation, linear JSON roundtrip prediction, and schema-safe prediction-error smoke checks are covered; package/build checks remain environment-specific; see [Month 1 release gate preflight](month1-release-gate-preflight-2026-05-18.md) |
| 5 | 2026-06-17 to 2026-06-23 | D4 validation matrix | Prioritized family validation schema and first JSON outputs | Started; prioritized-family validation schema seed and JSON plan added in [Month 2 family validation schema seed](month2-family-validation-schema-2026-05-18.md) |
