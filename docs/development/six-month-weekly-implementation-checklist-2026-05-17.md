...
| 3 | 2026-05-31 to 2026-06-06 | D3 capability gates | Runtime capability matrix fully aligned with docs and strict routing | Started; matrix artifact, HTTP/gRPC responses, `gamlss()` strict routing, and HTTP service route-admission reports now share the method-routing contract |
