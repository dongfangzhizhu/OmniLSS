...
| 2 | 2026-05-24 to 2026-05-30 | D1/D2 prediction hardening | Legacy prediction entry points audited; public artifact-schema examples added | In progress; artifact-schema docs, validator CLI, legacy prediction entry-point schema audit, and public error-envelope example added; indirect wrapper audit pending |
...
- Week 2 has started only after the core Week 1 gate: public artifact-schema examples and a validator CLI are now available; legacy prediction entry points now reuse the schema-safe prediction builder, as recorded in the [legacy prediction entry-point audit progress note](month1-legacy-prediction-entrypoint-audit-2026-05-18.md).
