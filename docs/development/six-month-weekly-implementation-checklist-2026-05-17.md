...
| 4 | 2026-06-07 to 2026-06-16 | Month 1 release gate | Core trust checkpoint with reproducible test evidence | Started; offline release preflight command added for docs-localization and capability-matrix validation; see [Month 1 release gate preflight](month1-release-gate-preflight-2026-05-18.md) |
