...
class TestDPQRRConsistency(unittest.TestCase):
    ...
    def _test_d_consistency(self, dist_name: str, x, params_dict):
        ...
        # R evaluation
        r_d = self.bus.eval_family(family=dist_name, func_type="d", args=params_dict)
    ...
    def _test_p_consistency(self, dist_name: str, q, params_dict):
        ...
        try:
            ...
            r_p = self.bus.eval_family(
                family=dist_name, func_type="p", args=params_dict
            )

            # JAX evaluation
            family = resolve_family(dist_name)
            params = tuple(
                params_dict[p] for p in family.parameters if p in params_dict
            )
    ...
    def _test_q_consistency(self, dist_name: str, p, params_dict):
        ...
        try:
            ...
            r_q = self.bus.eval_family(
                family=dist_name, func_type="q", args=params_dict
            )
    ...
    def test_NO_d_consistency(self):
        ...
        self._test_d_consistency(
            "NO", y, {"x": y.tolist(), "mu": mu.tolist(), "sigma": sigma.tolist()}
        )
    ...
    def test_NO_p_consistency(self):
        ...
        mu = np.linspace(-1, 1, 100)
        sigma = np.linspace(0.5, 2.0, 100)
        self._test_p_consistency(
            "NO", q, {"q": q.tolist(), "mu": mu.tolist(), "sigma": sigma.tolist()}
        )
    ...
    def test_NO_q_consistency(self):
        ...
        mu = np.linspace(-1, 1, 100)
        sigma = np.linspace(0.5, 2.0, 100)
        self._test_q_consistency(
            "NO", p, {"p": p.tolist(), "mu": mu.tolist(), "sigma": sigma.tolist()}
        )
    ...
    def test_GA_d_consistency(self):
        ...
        self._test_d_consistency(
            "GA", y, {"x": y.tolist(), "mu": mu.tolist(), "sigma": sigma.tolist()}
        )
    ...
    def test_GA_p_consistency(self):
        ...
        sigma = np.linspace(0.1, 1.0, 100)
        self._test_p_consistency(
            "GA", q, {"q": q.tolist(), "mu": mu.tolist(), "sigma": sigma.tolist()}
        )
    ...
    def test_GA_q_consistency(self):
        ...
        sigma = np.linspace(0.1, 1.0, 100)
        self._test_q_consistency(
            "GA", p, {"p": p.tolist(), "mu": mu.tolist(), "sigma": sigma.tolist()}
        )
    ...
    def test_GU_d_consistency(self):
        ...
        self._test_d_consistency(
            "GU", y, {"x": y.tolist(), "mu": mu.tolist(), "sigma": sigma.tolist()}
        )
    ...
    def test_GU_p_consistency(self):
        ...
        sigma = np.linspace(0.5, 3.0, 100)
        self._test_p_consistency(
            "GU", q, {"q": q.tolist(), "mu": mu.tolist(), "sigma": sigma.tolist()}
        )
    ...
    def test_GU_q_consistency(self):
        ...
        sigma = np.linspace(0.5, 3.0, 100)
        self._test_q_consistency(
            "GU", p, {"p": p.tolist(), "mu": mu.tolist(), "sigma": sigma.tolist()}
        )
    ...
    def test_RG_d_consistency(self):
        ...
        sigma = np.linspace(0.5, 3.0, 100)
        self._test_d_consistency(
            "RG", y, {"x": y.tolist(), "mu": mu.tolist(), "sigma": sigma.tolist()}
        )
    ...
    def test_RG_p_consistency(self):
        ...
        sigma = np.linspace(0.5, 3.0, 100)
        self._test_p_consistency(
            "RG", q, {"q": q.tolist(), "mu": mu.tolist(), "sigma": sigma.tolist()}
        )
    ...
    def test_RG_q_consistency(self):
        ...
        sigma = np.linspace(0.5, 3.0, 100)
        self._test_q_consistency(
            "RG", p, {"p": p.tolist(), "mu": mu.tolist(), "sigma": sigma.tolist()}
        )
    ...
    # Test BB family (fixed bd data parameter)
    def test_BB_d_consistency(self):
        y = np.arange(0, 20)
        mu = np.linspace(0.2, 0.8, 20)
        sigma = np.linspace(0.1, 0.8, 20)
        bd = np.full(20, 20)
        self._test_d_consistency(
            "BB",
            y,
    ...
    def test_BB_p_consistency(self):
        q = np.arange(0, 20)
        mu = np.linspace(0.2, 0.8, 20)
        sigma = np.linspace(0.1, 0.8, 20)
        bd = np.full(20, 20)
    ...
    def test_BB_q_consistency(self):
