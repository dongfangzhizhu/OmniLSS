...
This tutorial follows the `tutorials/README.md` plan for **Simplex and Other Bounded Distributions**.
...
- Add diagnostics and interpretation specific to **Simplex and Other Bounded Distributions**.
