# Exponential and Weibull - EXP, WEI, LO

[中文版本](03_exponential_weibull_cn.md)
...
This tutorial follows the `tutorials/README.md` plan for **Exponential and Weibull — EXP, WEI, LO**.
...
- Add diagnostics and interpretation specific to **Exponential and Weibull — EXP, WEI, LO**.
