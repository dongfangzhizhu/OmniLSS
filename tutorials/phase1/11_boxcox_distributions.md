...
This tutorial follows the `tutorials/README.md` plan for **Box-Cox Transformation — BCCG, BCT, BCPE**.
...
- Add diagnostics and interpretation specific to **Box-Cox Transformation — BCCG, BCT, BCPE**.
