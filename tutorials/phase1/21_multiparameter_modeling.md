...
[中文版本](21_multiparameter_modeling_cn.md)
...
This tutorial follows the `tutorials/README.md` plan for **Multi-Parameter Modeling**.
...
- Add diagnostics and interpretation specific to **Multi-Parameter Modeling**.
