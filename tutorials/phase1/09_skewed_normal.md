...
This tutorial follows the `tutorials/README.md` plan for **Skewed Normal — SN1, SN2, SHASH, SHASHo**.
...
- Add diagnostics and interpretation specific to **Skewed Normal — SN1, SN2, SHASH, SHASHo**.
