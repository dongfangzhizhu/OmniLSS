...
This tutorial follows the `tutorials/README.md` plan for **Binomial Family — BI, BB, BNB**.
...
- Add diagnostics and interpretation specific to **Binomial Family — BI, BB, BNB**.
