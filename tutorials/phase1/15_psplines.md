...
This tutorial follows the `tutorials/README.md` plan for **P-splines (pb) — Penalized B-splines**.
...
- Add diagnostics and interpretation specific to **P-splines (pb) — Penalized B-splines**.
