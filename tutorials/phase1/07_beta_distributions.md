...
This tutorial follows the `tutorials/README.md` plan for **Beta Family — BE, BEINF, BEZI, BEOI**.
...
- Add diagnostics and interpretation specific to **Beta Family — BE, BEINF, BEZI, BEOI**.
