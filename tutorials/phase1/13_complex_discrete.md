...
This tutorial follows the `tutorials/README.md` plan for **Complex Discrete — PIG, SICHEL, DPO, DEL**.
...
- Add diagnostics and interpretation specific to **Complex Discrete — PIG, SICHEL, DPO, DEL**.
