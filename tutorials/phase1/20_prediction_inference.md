...
This tutorial follows the `tutorials/README.md` plan for **Prediction and Inference**.
...
- Add diagnostics and interpretation specific to **Prediction and Inference**.
