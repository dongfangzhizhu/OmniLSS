...
[中文版本](22_distribution_selection_cn.md)
...
This tutorial follows the `tutorials/README.md` plan for **Distribution Selection and Comparison**.
...
- Add diagnostics and interpretation specific to **Distribution Selection and Comparison**.
