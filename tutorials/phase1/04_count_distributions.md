...
This tutorial follows the `tutorials/README.md` plan for **Count Distributions — PO, NBI, NBII, GEOM**.
...
- Add diagnostics and interpretation specific to **Count Distributions — PO, NBI, NBII, GEOM**.
