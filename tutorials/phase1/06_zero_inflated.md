...
This tutorial follows the `tutorials/README.md` plan for **Zero-Inflated Distributions — ZIP, ZINBI, ZAGA, ZAIG**.
...
- Add diagnostics and interpretation specific to **Zero-Inflated Distributions — ZIP, ZINBI, ZAGA, ZAIG**.
