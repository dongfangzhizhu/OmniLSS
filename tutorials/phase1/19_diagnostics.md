...
This tutorial follows the `tutorials/README.md` plan for **Model Diagnostics — Residual Analysis**.
...
- Add diagnostics and interpretation specific to **Model Diagnostics — Residual Analysis**.
