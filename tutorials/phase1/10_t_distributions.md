...
This tutorial follows the `tutorials/README.md` plan for **t-Distribution Family — TF, GT, ST series**.
...
- Add diagnostics and interpretation specific to **t-Distribution Family — TF, GT, ST series**.
