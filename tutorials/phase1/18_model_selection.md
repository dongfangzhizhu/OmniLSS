# Model Selection - AIC, BIC, GAIC

[中文版本](18_model_selection_cn.md)
...
This tutorial follows the `tutorials/README.md` plan for **Model Selection — AIC, BIC, GAIC**.
...
- Add diagnostics and interpretation specific to **Model Selection — AIC, BIC, GAIC**.
